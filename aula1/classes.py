...
class Televisao: 
    ...
    def __str__(self) -> str:
        return f'Televisao - ligada {self.ligada} - canal {self.canal} - volume {self.volume}' #o f formata a saída
    
# Criando instancias da class Televisao

tv_sala = Televisao()
tv_quarto = Televisao()
# quando chamamos o metodo ligar()
