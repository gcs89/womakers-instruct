...
class Estacionamento:
    ...
    def estacionar_moto(self):
        if (self.motos_para_vaga <= 1) and (self.total_vagas_livres_moto >= 1) and (self.total_vagas_livres_moto <= 5):
            print("Está livre para estacionar moto.")
        elif (self.total_vagas_livres_moto == 0) and (self.motos_para_vaga > 1) and (self.total_vagas_livres_carro <= 5) and (self.carros_para_vaga == 0):
    ...
    def remover_carro(self, carro: Carro, vaga: Vaga):
        print("O carro de placa {} foi removido da vaga {}".format(carro.placa, vaga.id_vaga))
